import svgPaths from "./svg-x1k2ooy54";
...
function Return() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative rounded-[8.5px] shrink-0" data-name="Return">
      ...
      <div className="absolute flex flex-col font-['SF_Pro:Regular',sans-serif] font-normal h-[42px] justify-center leading-[0] left-0 right-0 text-[19px] text-center text-white top-[calc(50%+2.5px)] translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Keyboard() {
  return (
    <div className="absolute content-stretch flex flex-col h-[307px] items-start left-px rounded-bl-[62px] rounded-br-[62px] rounded-tl-[27px] rounded-tr-[27px] top-[805px] w-[402px]" data-name="Keyboard">
      <Background />
      <Frame4 />
    </div>
  );
...
export default function Profile() {
  return (
    <div className="bg-white overflow-clip relative rounded-[16px] size-full" data-name="Profile">
      <Navigation />
      <StatusBarIPhone />
      <HomeIndicator />
      <Content />
