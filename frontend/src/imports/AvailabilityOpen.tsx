import svgPaths from "./svg-wfk86v4h8m";
...
function MenuIPhone() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-center left-[73px] px-0 py-[8px] shadow-[2px_2px_15px_0px_rgba(0,0,0,0.25)] top-[130px] w-[188px]" data-name="Menu - iPhone">
      <Blur1 />
      <Fill />
      <GlassEffect />
      <MenuItems />
