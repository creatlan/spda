import svgPaths from "./svg-t5snvn2d4w";
...
function Alert() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[10px] items-start justify-center left-[24px] p-[14px] top-[318px] w-[356px]" data-name="Alert">
      <Blur1 />
      <Fill />
      <GlassEffect />
      <TitleAndDescription />
...
export default function Availability() {
  return (
    <div className="bg-white overflow-clip relative rounded-[16px] size-full" data-name="Availability">
      <StatusBarIPhone />
      <HomeIndicator />
      <div className="absolute backdrop-blur-[2px] backdrop-filter bg-[rgba(0,0,0,0.15)] h-[875px] left-0 top-0 w-[401px]" />
      <Alert />
      <Month />
      <Calendar />
      <Tally />
