import svgPaths from "./svg-e6acfk1vpd";
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-px top-[81px] w-[370px]">
      <Card />
      <Frame13 />
      <Frame14 />
    </div>
...
function Content() {
  return (
    <div className="absolute h-[1036px] left-[15px] overflow-x-clip overflow-y-auto top-[62px] w-[372px]" data-name="Content">
      <p className="absolute font-['SF_Pro:Bold',sans-serif] font-bold h-[40px] leading-[41px] left-px text-[34px] text-black top-[9px] tracking-[0.4px] w-[370px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        WorkPlan
      </p>
      <Frame15 />
    </div>
...
function Overlay() {
  return (
    <div className="absolute bg-white h-[705px] left-0 overflow-clip rounded-[16px] shadow-[0px_0px_15px_0px_rgba(0,0,0,0.25)] top-[1091px] w-[401px]" data-name="Overlay">
      <Frame25 />
      <Frame16 />
    </div>
  );
...
export default function Home() {
  return (
    <div className="bg-white overflow-clip relative rounded-[16px] size-full" data-name="Home (вечерняя смена)">
      <Overlay />
      <Navigation />
      <HomeIndicator />
      <StatusBarIPhone />
